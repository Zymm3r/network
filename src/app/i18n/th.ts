export const th = {
  ...
  dashboardStudent: {
    ...
    keepUpWork: 'ทำได้ดีมาก! คุณเรียนติดต่อกันมา {streak} วันแล้ว! 🔥',
    level: 'เลเวล',
    xpToNextLevel: 'XP ถึงเลเวลถัดไป',
    currentProgress: 'ความคืบหน้าปัจจุบัน',
    resumeLearning: 'เรียนต่อเลย',
    enrolled: 'ลงทะเบียน',
    completed: 'สำเร็จแล้ว',
    studyTime: 'เวลาเรียน',
    streak: 'เรียนติดต่อกัน',
    learningActivity: 'กิจกรรมการเรียนรู้',
    learningActivityDesc: 'ผลการเรียนของคุณในทุกแบบฝึกหัด',
    exerciseSuccessRate: 'อัตราความสำเร็จของแบบฝึกหัด',
    overallCompletionRate: 'อัตราความคืบหน้าโดยรวม',
    achievements: 'ความสำเร็จ',
    achievementsDesc: 'เป้าหมายที่คุณพิชิตแล้ว',
    firstSteps: 'ก้าวแรก',
    firstStepsDesc: 'ลงทะเบียน 1 หลักสูตรขึ้นไป',
    fastLearner: 'เรียนรู้ไว',
    fastLearnerDesc: 'เรียนจบ 10 บทเรียนขึ้นไป',
    dedicated: 'มุ่งมั่น',
    dedicatedDesc: 'เรียนมากกว่า 10 ชั่วโมง',
    unstoppable: 'หยุดไม่อยู่',
    unstoppableDesc: 'เรียนติดต่อกัน 7 วัน',
    days: 'วัน',
    hrs: 'ชม.',
  },
  dashboardAnalytics: {
