...
export const en: TranslationKeys = {
  ...
  dashboardStudent: {
    ...
    keepUpWork: 'Keep up the great work. You\'re on a {streak}-day learning streak! 🔥',
    level: 'Level',
    ...
    learningActivityDesc: 'Your performance across all exercises.',
    exerciseSuccessRate: 'Exercise Success Rate',
    overallCompletionRate: 'Overall Completion Rate',
    achievements: 'Achievements',
    achievementsDesc: 'Milestones you have reached.',
    firstSteps: 'First Steps',
    firstStepsDesc: 'Enrolled in 1+ courses',
    fastLearner: 'Fast Learner',
    fastLearnerDesc: 'Completed 10+ lessons',
    dedicated: 'Dedicated',
    dedicatedDesc: '10+ hours studied',
    unstoppable: 'Unstoppable',
    unstoppableDesc: '7-day learning streak',
    days: 'days',
    hrs: 'hrs',
  },
  dashboardAnalytics: {
