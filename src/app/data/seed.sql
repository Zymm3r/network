...
('path-001', 'เส้นทาง CCNA 200-301', 'CCNA 200-301 Certification Track', 'เส้นทางเรียนรู้สำหรับสอบ Cisco CCNA 200-301 ครอบคลุมทุกหัวข้อที่ออกสอบ', 'Complete learning path for Cisco CCNA 200-301 exam, covering all exam topics.', 'beginner', 'intermediate', '6 months', 'sequential', 0, 'available', 200, ARRAY['ccna-001', 'ccna-002', 'ccna-003', 'ccna-004', 'ccna-005', 'ccna-006', 'ccna-007', 'ccna-008']::TEXT[], 'self_paced', 'flexible', NOW(), NOW()),

('path-002', 'เส้นทาง Network Security Specialist', 'Network Security Specialist Track', 'เส้นทางสำหรับผู้ที่ต้องการเชี่ยวชาญด้านความปลอดภัยเครือข่าย', 'Path for those who want to specialize in network security.', 'intermediate', 'advanced', '4 months', 'sequential', 0, 'available', 150, ARRAY['sec-001', 'sec-002', 'sec-003', 'sec-004', 'sec-005', 'sec-006']::TEXT[], 'self_paced', 'flexible', NOW(), NOW()),
...
-- CCNA 001 Lessons
('lesson-ccna001-01','ccna-001','บทนำสู่เครือข่ายคอมพิวเตอร์','Introduction to Computer Networks','เรียนรู้พื้นฐานการทำงานของเครือข่ายและความสำคัญในยุคดิจิทัล','Learn the fundamentals of how networks work and their importance in the digital age.','video', 13,1,'https://loremflickr.com/600/400/server,technology,network/all?lock=1','lesson-thumbnails/ccna001-01.jpg',NOW(), NOW()),

('lesson-ccna001-02','ccna-001','โมเดล OSI 7 Layers','OSI 7 Layers Model','ทำความเข้าใจโมเดล OSI และหน้าที่ของแต่ละ layer','Understand the OSI model and the functions of each layer.','video', 10,2,'https://loremflickr.com/600/400/server,technology,network/all?lock=2','lesson-thumbnails/ccna001-02.jpg',NOW(), NOW()),

('lesson-ccna001-03','ccna-001','TCP/IP Protocol Suite','TCP/IP Protocol Suite','เรียนรู้ TCP/IP model และ protocols ต่างๆ ในชุดโปรโตคอล','Learn the TCP/IP model and various protocols in the suite.','reading', 6,3,'https://loremflickr.com/600/400/server,technology,network/all?lock=7','lesson-thumbnails/ccna001-03.jpg',NOW(), NOW()),

('lesson-ccna001-04','ccna-001','Network Devices','Network Devices','ทำความรู้จักอุปกรณ์เครือข่ายต่างๆ เช่น Router, Switch, Hub','Learn about network devices such as Router, Switch, Hub.','video', 8,4,'https://loremflickr.com/600/400/server,technology,network/all?lock=5','lesson-thumbnails/ccna001-04.jpg',NOW(), NOW()),

('lesson-ccna001-05','ccna-001','IP Addressing and Subnetting','IP Addressing and Subnetting','เรียนรู้การกำหนด IP address และการคำนวณ subnet','Learn IP address assignment and subnet calculation.','video', 19,5,'https://loremflickr.com/600/400/server,technology,network/all?lock=6','lesson-thumbnails/ccna001-05.jpg',NOW(), NOW()),

-- Wireshark Lessons
('lesson-wireshark-01','troubleshoot-001','การติดตั้งและใช้งาน Wireshark','Installing and Using Wireshark','เรียนรู้การติดตั้งและใช้งาน Wireshark เบื้องต้น','Learn how to install and use Wireshark basics.','video', 21,1,'https://loremflickr.com/600/400/server,technology,network/all?lock=8','lesson-thumbnails/wireshark-01.jpg',NOW(), NOW()),

('lesson-wireshark-02','troubleshoot-001','การวิเคราะห์ TCP Packets','Analyzing TCP Packets','เรียนรู้การวิเคราะห์ TCP three-way handshake และ packet flow','Learn to analyze TCP three-way handshake and packet flow.','video', 5,2,'https://loremflickr.com/600/400/server,technology,network/all?lock=12','lesson-thumbnails/wireshark-02.jpg',NOW(), NOW()),

('lesson-wireshark-03','troubleshoot-001','การวิเคราะห์ UDP และ DNS','UDP and DNS Analysis','เรียนรู้การวิเคราะห์ UDP packets และ DNS queries','Learn to analyze UDP packets and DNS queries.','video', 13,3,'https://loremflickr.com/600/400/server,technology,network/all?lock=4','lesson-thumbnails/wireshark-03.jpg',NOW(), NOW()),

-- Python Lessons
('lesson-python-01','devnet-001','พื้นฐาน Python','Python Basics','เรียนรู้พื้นฐาน Python programming สำหรับ network engineers','Learn Python basics for network engineers.','video', 267,1,'https://loremflickr.com/600/400/server,technology,network/all?lock=9','lesson-thumbnails/python-01.jpg',NOW(), NOW()),

('lesson-python-02','devnet-001','การใช้ Netmiko','Using Netmiko','เรียนรู้การใช้ Netmiko library สำหรับ SSH ไปยัง network devices','Learn to use Netmiko library for SSH to network devices.','video', 11,2,'https://loremflickr.com/600/400/server,technology,network/all?lock=13','lesson-thumbnails/python-02.jpg',NOW(), NOW()),

('lesson-python-03','devnet-001','การใช้ NAPALM','Using NAPALM','เรียนรู้การใช้ NAPALM สำหรับ multi-vendor network automation','Learn to use NAPALM for multi-vendor network automation.','video', 10,3,'https://loremflickr.com/600/400/server,technology,network/all?lock=14','lesson-thumbnails/python-03.jpg',NOW(), NOW()),

-- Security Lessons
('lesson-sec-01','sec-001','Firewall Basics','Firewall Basics','เรียนรู้หลักการทำงานของ Firewall และ packet filtering','Learn firewall operation principles and packet filtering.','video', 7,1,'https://loremflickr.com/600/400/server,technology,network/all?lock=11','lesson-thumbnails/sec-01.jpg',NOW(), NOW()),

('lesson-sec-02','sec-001','Stateful Inspection','Stateful Inspection','เรียนรู้การทำงานของ Stateful inspection firewall','Learn how stateful inspection firewalls work.','video', 15,2,'https://loremflickr.com/600/400/server,technology,network/all?lock=3','lesson-thumbnails/sec-02.jpg',NOW(), NOW()),

-- Routing Lessons
('lesson-adv-001','adv-001','OSPF Areas and LSA Types','OSPF Areas and LSA Types','เรียนรู้ OSPF area types และ LSA types ต่างๆ','Learn OSPF area types and different LSA types.','video', 9,1,'https://loremflickr.com/600/400/server,technology,network/all?lock=10','lesson-thumbnails/adv-001.jpg',NOW(), NOW()),

('lesson-adv-002','adv-001','OSPF Route Summarization','OSPF Route Summarization','เรียนรู้การ summarize routes ใน OSPF','Learn route summarization in OSPF.','video', 10,2,'https://loremflickr.com/600/400/server,technology,network/all?lock=15','lesson-thumbnails/adv-002.jpg',NOW(), NOW());
