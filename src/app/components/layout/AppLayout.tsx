...
export function AppLayout() {
  ...
  // ─── Loading Gate ──────────────────────────────────────────────
  // Wait for auth bootstrap to complete before making any routing
  // decisions. This prevents flashing to /auth during session restore
  // on refresh, tab switch, or browser reopen.
  if (!initialized) {
    return (
  ...
  // ─── Auth Gate ─────────────────────────────────────────────────
  // Only redirect AFTER initialization confirms there's truly no session.
  if (!user) {
