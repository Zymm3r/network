...
- Name: tier2.spec.ts >> Tier 2: Boundary & Corner Cases >> F3: Simulator UI & Status >> Maximized Device Clutter
- Location: e2e\tier2.spec.ts:162:5
...
Call log:
  - waiting for getByTestId('device-node-1')
