...
Call log:
  - waiting for getByTestId('lesson-item-0')
    2 × waiting for" http://localhost:5173/equipment/product-long-text?tab=training" navigation to finish...
      - navigated to "http://localhost:5173/equipment/product-long-text?tab=training"
