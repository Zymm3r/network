...
- Name: tier2.spec.ts >> Tier 2: Boundary & Corner Cases >> F3: Simulator UI & Status >> Self-Connection/Loop Attempt
- Location: e2e\tier2.spec.ts:128:5
...
Call log:
  - waiting for getByTestId('device-port-A')
    - waiting for" http://localhost:5173/equipment/123?tab=simulator" navigation to finish...
    - navigated to "http://localhost:5173/equipment/123?tab=simulator"
