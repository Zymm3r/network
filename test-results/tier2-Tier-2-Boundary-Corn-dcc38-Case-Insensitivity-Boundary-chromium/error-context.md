...
- Name: tier2.spec.ts >> Tier 2: Boundary & Corner Cases >> F4: Simulator Scenarios >> Case Insensitivity Boundary
- Location: e2e\tier2.spec.ts:181:5
...
Locator: getByTestId('scenario-nvr')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByTestId('scenario-nvr')
