...
```yaml
- img
- heading "Network 101" [level=1]
- paragraph: การสร้างเครือข่ายพื้นฐาน
- heading "ยินดีต้อนรับ" [level=4]
- paragraph: กรอกอีเมลเพื่อรับลิงก์เข้าสู่ระบบ ไม่ต้องใช้รหัสผ่าน
- text: ที่อยู่อีเมล
- img
- textbox "ที่อยู่อีเมล":
  - /placeholder: email@example.com
- button "ส่งลิงก์เข้าสู่ระบบ":
  - img
  - text: ส่งลิงก์เข้าสู่ระบบ
  - img
- paragraph: ไม่ต้องสร้างรหัสผ่าน — เราจะส่งลิงก์ไปยังอีเมลของคุณเพื่อเข้าสู่ระบบทุกครั้ง เซสชันจะคงอยู่ 3 วัน
