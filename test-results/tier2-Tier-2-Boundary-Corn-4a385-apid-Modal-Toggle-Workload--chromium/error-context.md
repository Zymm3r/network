...
- Name: tier2.spec.ts >> Tier 2: Boundary & Corner Cases >> F2: Training Media Modal >> Rapid Modal Toggle (Workload)
- Location: e2e\tier2.spec.ts:79:5
...
Call log:
  - waiting for getByTestId('lesson-item-0')
