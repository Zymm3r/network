...
- Name: tier1.spec.ts >> Tier 1: Feature Coverage >> F1: Equipment Tabs Navigation >> Verify default tab selection
- Location: e2e\tier1.spec.ts:9:5
...
Locator: getByRole('tab', { name: 'Overview' })
Expected: "true"
Timeout: 5000ms
