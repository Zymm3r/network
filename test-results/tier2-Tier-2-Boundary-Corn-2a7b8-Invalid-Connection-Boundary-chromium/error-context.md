...
- Name: tier2.spec.ts >> Tier 2: Boundary & Corner Cases >> F3: Simulator UI & Status >> Invalid Connection Boundary
- Location: e2e\tier2.spec.ts:117:5
...
Call log:
  - waiting for getByTestId('completion-percentage')
